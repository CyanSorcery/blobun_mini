...
function add_undo()
 ...
 _undo.obj_list = {}
 for _k,_v in pairs(g_list_obj) do
 _undo.obj_list[_k] = g_list_obj[_k]
 end
...
function perform_undo()
 ...
 g_new_dir, g_stage_lose, _player.isdead, g_updt_coin, g_updt_zap, _player.ismove = -1, false, false, true, true, false
