...
local _s = "012056001015000056004056008015005056000056001015004056017059015001112127017060015008017059112127015001017067036056001015000056037056008015036056000056001015044056049067015001112127049059015008049060112127015001049059"

for _b = 1,216,18 do
 sspr(subl(_s, _b, 0, 2), subl(_s, _b + 3, 0, 2), subl(_s, _b + 6, 0, 2),subl(_s, _b + 9, 0, 2), subl(_s, _b + 12, 0, 2), subl(_s, _b + 15, 0, 2))
end
