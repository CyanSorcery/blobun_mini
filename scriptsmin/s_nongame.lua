...
if(btnp(1)and g_sss_menu_world<count(g_levels)and stages_beat_in_world(g_sss_menu_world)>=g_w_req[g_sss_menu_world])g_play_sfx=61700g_sss_menu_world_tgt=min(g_sss_menu_world+1,_worlds)g_sss_anim_incr=-.125
