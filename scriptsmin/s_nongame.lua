...
palt()fillp(g_fillp_transition[flr(lerp(1,4,_baseanim))])rectfill(0,56,127,72,12)fillp()end function update_credits()if(g_intro_anim*g_outro_anim==1and btnp()&48>0)if g_victory_mode==5then set_game_mode(1)else set_game_mode(0)end
