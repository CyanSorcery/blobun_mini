...
end function draw_credits()for _x=-32+g_bg_scl,128,32do for _y=-g_bg_scl,128,32do spr(204,_x,_y,4,4)end end if(g_victory_mode==nil)poke(24404,96)pal(g_pal_dark[1])sspr(0,58,128,70,0,58)sspr(0,7,128,18,0,7)sspr(39,38,52,20,39,38)pal()poke(24404,0)palt(4096)map(48,0,0,0,16,16)local _t={{"programming","bug fixes","general"},{"art, music","art, music","music"}}for _x=1,2do for _y=1,3do print_shd(_t[_x][_y],_x*64-46,_y*24+42,7,1)end end print_shd("director",58,42,7,1)print_shd("created by",44,1,7,1)print_shd("a plural system",34,26,7,1)print_shd("seven spirits, one body",18,32,7,1)else poke(24404,96)pal(g_pal_dark[1])sspr(0,0,128,128,0,0)pal()poke(24404,0)palt(4096)map(32,8+g_victory_mode*2,0,32,16,2)local _str={[[ you've overcome many
...
pal(7,_is_hilite and 7or _t[g_sss_menu_world][2])if _y>0then?(_y>9and""or" ").._y.." ".._st.s_name,15,_syt,7
