...
j,U,fm,fZ,x=e,f,n,o,0fy()if(j~=2)music(-1,500)f5=false
end function fg(f,e)fS,fY,x,g=f,e,0,{}pal()end function e(f,e,n)fp(6)fw(1)fv(1,0,0)music(h(5)and f or-1,0,7)u=0fg(e,n)end function fx()e(-1,e1,e0)V=90end function fT()e(0,e3,e4)end function fU()e(4,ef,e2)local f=fk()r,N=mid(1,f.world,count(b))w=mid(1,f.stage,count(b[r]))u,q,C,ee=0,0,.125,J("13b224cd02415d6d2494",4)end function fW()e(4,fz,fF)M=nil end function fX()e(4,fz,fF)end function fV(f,e)fg(en,e8)local n=ff~=2f=mid(1,f,count(b))e=mid(1,e,count(b[f]))B,L,i=f,e,b[f][e]e5(f,e)f6,f_,W,X=0,61936.8827,0,0g,k,l,Y,fa,z,K,Z,O,fj,x,A,fq,f1,D,fd,f0,P,eo,e6,ea,ed={},false,false,false,false,0,true,false,0,false,fZ==true and 0or 90,0,false,{},{},{{},{}},1,i.s_tiles,fA(),fc(),E(false),E(true)fw(2)fp(f)if(n)poke(24405,0)local e=J("2854ef234924d6d54924",4)for n=1,4do pal(e[1][n],e[f][n])end spr(1,8,0,14,1)spr(16,0,8,2,2)poke(24405,96)ec(f)fv(2,96,0)
...
end rect(96,1,126,7,7)fillp(f7[ceil(T)])rectfill(124-max(1,g[1].tilestouched/P*26),3,124,5,59)fillp()if(l or k)fl(l and"stage clear!"or"❎ undo",l and 42or 50,f+5,7,1.3)
...
f.nextdir,f.dir=-1,e if o and not k then fq=true if(y==nil and stat(49)==-1and not f.onconvey)y=61956
...
end function ek(f)f.ismove=false local o,a,d,c,l,h=f.x,f.y,(f.oldx<<1)+2,(f.oldy<<1)+1,true,true if(f.prevcrackedfloor)v(96,18,d-1,c)P-=R(d,c)f.tilestouched-=1y=62278f.prevcrackedfloor=false
...
Z=true end if(f.prevslimetrap)v(126,26,d-1,c)y=62084
...
end end if(e==123and f.pstate==1)e=192v(104,18,r,t)
if(e>208)fG(f)h=false
if e\16==11and f.pstate==0or e\16==12or e==50or e==29and z==0or e==30and z==1or e==31and z==2then fG(f,true)elseif h then f.tilestouched+=1v(126,f.pstate<<1,r,t)end if(n~=nil)fH(b,u+8,I(n))
...
end)f.i_setting=e return f end function e9()Y,fa,y=false,false,61828local f if(not eo and fA())f=1
