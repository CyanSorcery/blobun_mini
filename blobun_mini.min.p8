...
local a=d>e and b(c,d-1)or 0local e=l[a]or{unpack(n)}l[a]=e local f=e[o and 1or f"2"]i(e,f)i(n,f)r(c,d,f)end end end function er()local f={}f.obj_list,f.player,f.g_p_zap_turn,f.g_tile_count,f.playfield=fD(g),fD(g[1]),F,Q,et()add(G,f)if(count(G)>60)deli(G,1)
end function e7()local e=count(G)if(e==0)return
local f=G[e]if(e>0)deli(G)
g=f.obj_list g[1]=f.player F,Q=f.g_p_zap_turn,f.g_tile_count local e=g[1]e.nextdir,e.isdead,e.ismv,z,f1,M=-1,false,false,false,true,true eu(f.playfield)end function et()local f={}for e=0,34do f[e]={}for n=0,31do f[e][n]=mget(e,n)end end return f end function eu(n)for f=0,34do for e=0,31do mset(f,e,n[f][e])end end end function fD(e)local f={}for e,n in pairs(e)do f[e]=n end return f end function c(n,f,a,e)return tonum(sub(n,f,f+(e and e or 0)),a)end function L(n,f)local a,o,e={},#n\f for o=1,o do e=(o-1)*f a[o]=K(sub(n,e+1,e+f))end return a end function K(f)local e={}for n=1,#f do add(e,c(f,n,1))end return e end function p(f,e,n)return f+(e-f)*n end function k(a,o,d,e)for n=0,1do for f=0,1do if(e+f<32)mset(d+n,e+f,mget(a+n,o+f))
end end end function R(a,o,f,e)local e,n,d,c,i,l,f=i.s_w<<1,i.s_h<<1,48+f\16<<1,f%16<<1,48+e\16<<1,e%16<<1for e=1,e,2do for n=1,n,2do f=mget(e+1,n)if f==a then k(i,l,e,n)elseif f==o then k(d,c,e,n)end end end end function S(f,e)local n=mget(f,e)if(n~=125and n~=127)return 0
k(126,24,f-1,e)return 1+S(f-2,e)+S(f+2,e)+S(f,e-2)+S(f,e+2)end function fb(e,n,a,o,d)local f=#e for f=1,f do n=print(sub(e,f,f),n,a+sin(f2+f/10)*d,o)end end function y(f,e,n,a,o)?f,e+1,n+1,o
return print(f,e,n,a)end function fE(f)return(f>=60and flr(f/60)..":"or"")..sub(flr(f%60)+100,2,3).."."..sub(flr(f%1*1000)+1000,2,4)end function en()local f=j*a==1f8+=.075f8%=1fa+=.015fa%=1if(x==45and f5==false)music(h(5)and 0or-1,0,7)f5=true
if x<=45and f then if(btn(6))poke(24368,1)
if((Z and l or btn(6))and count(d)==0)es()
end O=mid(0,count(d)==0and(l or z)and O+.2or O-.2,1)if(f)for f in all(g)do f:onstep()end eh()
local f,e,n=g[1],i.s_w<<4,i.s_h<<4local a=f.inprt and cos(1-f.anim>>2)or f.anim X=i.s_w>=8and mid(0,(p(f.oldx,f.x,a)<<4)-48,e-112)or(e>>1)-56Y=i.s_h>7and mid(-8,(p(f.oldy,f.y,a)<<4)-48,n-108)or(n>>1)-60end function e5()poke(24405,0)if(fe)ex()else ey()
if(M)em()
if(f1)eg()
ep()poke(24405,96)palt(0)local f,e=-32+n,-n if(v>=3)f,e=-32+-X/2,-32+-Y/2
for f=f,128,32do for e=e,128,32do spr(148,f,e,4,2)spr(152,f,e+16,4,2)end end poke(24404,96)pal()if(v<=2)for f=0,127do sspr(0,f,128,1,sin(fa+(f>>4))*1.4,f)end
poke(24404,0)camera(X,Y)local f,e=i.s_w*2+2,i.s_h*2+2palt(256)map(0,0,0,0,f,e,1)fG()map(0,0,-7,0,f,e,128)fG()for f in all(fd[f0])do f:ondraw()end palt(16384)map(0,0,0,0,f,e,12)palt()map(0,0,0,0,f,e,2)for f in all(g)do f:ondraw()end ew()camera(0,0)local a,o=h(1),count(d)local f,e=p(127,115,O),a and 0or 87poke(24404,96)pal(fs)if o>0then sspr(0,0,128,128,0,0)else sspr(e,0,128,9,e,0)if(O>0)sspr(0,f,128,16,0,f)
end pal()poke(24404,0)local e=B<=i.s_gt and 7or 13if(l and B<=i.s_dt)e=10
local n=dget(i.s_st)spr(n<599.995and 147or 146,88,0)if a then?fE(B),2,2,e
if(fq)fb("new time!",32,2,e,1.3)
if(n<=i.s_gt)?"⧗",81,2,9
if(n<=i.s_dt)?"♥",75,2,14
end local e=g[1].ttch rect(96,1,126,7,7)fillp(f7[ceil(U)])rectfill(124-max(1,e/Q*26),3,124,5,59)fillp()if(l or z)fb(l and"stage clear!"or"❎ undo",l and 42or 50,f+5,7,1.3)
if o==1then local f=sin(d[1].m_anim_factor>>2)*-32+-24local e=y("stage "..C,f,106,7,0)line(f-2,112,f+e,112,7)y(i.s_nm,f,115,7,0)y(i.s_at,f,122,13,0)elseif not l and v==1and C==1and e>5then y("🅾️ sprint",12,12,7,0)end end function ex()local f="0c38010f00380438080f05380038010f0438113b0f01587f113c0f08113b587f0f0111432438010f00382538080f24380038010f2c3831430f01587f313b0f08313c587f0f01313b"for e=1,144,12do sspr(c(f,e,1,1),c(f,e+2,1,1),c(f,e+4,1,1),c(f,e+6,1,1),c(f,e+8,1,1),c(f,e+10,1,1))end line(88,127,104,127,0)line(0,56,0,71,0)end function ey()local o,e,f,n,a=fj,0,0,false,false for e=0,10do f,n,a=21+e,o&1<<e>0,o&8<<e>0sset(f,98,n and 7or 12)sset(f,96,a and 7or 0)sset(f,92,n and 9or 4)sset(f,90,o&32<<e>0and 10or 9)sset(f,88,a and 10or 0)end for e=0,4do f,n,a=8+e,o&16<<e>0,o&64<<e>0sset(f,98,n and 7or 12)sset(f,96,a and 7or 0)sset(f,90,n and 10or 9)sset(f,88,a and 10or 0)end for d=0,7do f,n,a=103-d,95-d,88+d e=o&1<<d>0and 7or 12sset(f,101,e)sset(50,103-d,e)sset(78,96+d,e)e=o&1<<d>0and 9or 4sset(f,91,e)sset(52,n,e)sset(76,a,e)e=o&4<<d>0and 9or 10sset(f,93,e)sset(50,n,e)sset(78,a,e)end fj>><=1end function ep()local a=f8 spr(224,80,104,6,2)local f,n=80for o=0,32,16do clip(f,104,16,16)for e=0,15do n=sin(a+e/8)+104sspr(o+e,112,1,16,f+e,n)sspr(f,104+e,16,1,f,n+e)end f+=16end local e=g[1]clip()palt(0,false)spr(208,24,104,3,1)palt()if(e.haskey)spr(144,32,104)spr(144,39,104,1,1,true)
...
local e,n,f=(btn(4)or e.sprint)and e.oncnv==false,e.blink<4or l f=e and 214or 215if(n or z)f=216
spr(f,l and 37or 36,104,1,1,l)f=e and 252or 251if(z)f=160
if(l)f=250
spr(f,40,104)for f=0,23do for e=0,7do sset(79-e,104+f,sget(24+f,104+e))end end end ek=L("1d5cdc125848145949",6)function em()local f,n for e=1,3do n,f=((F+3-e)%3<<1)+1,ek[e]pal(f[3],f[n])pal(f[4],f[n+1])spr(155+e,96+(e<<3),8,1,2)end pal()M=false end function fG()poke(24405,0)camera(0,0)local f,e for n=0,34do f,e=(n<<3)%128,(n\16<<4)+8sspr(f,e,8,16,f,e,8,16,true)end camera(X,Y)poke(24405,96)end function eg()local o,e,a,f=g[1].coins for n=0,1do e,a=4,5if(o>n)e,a=9,4
f=17-n*3for n=0,8,8do line(72+n,f,76+n,f,e)line(72+n,f-1,75+n,f-1,e)f+=1e=a end end f1=false end function eb(e)local f={type=c(e,1,1),x=c(e,2,1),y=c(e,3,1),spr=c(e,4,1,1),anim=rnd(),spin=rnd()}f.poskey=f.x<<4|f.y if f.type==0then f.stx,f.sty,f.poskey,f.dir,f.anim,f.jgl,f.sprint,f.pstate,f.ismv,f.oldx,f.oldy,f.strnx,f.strny,f.haskey,f.oncnv,f.inprt,f.blink,f.octg,f.coins,f.nextdir,f.ttch,f.isdead,f.prvsltr,f.prvcrfl=f.x,f.y,-1,3,1,0,false,0,false,f.x,f.y,f.x,f.y,false,false,false,10,0,0,-1,1,false,false,false f.onstep=ev f.ondraw=ez else if(f.type==5)f.oct_ind=f.spr f.spr=87
...
sspr(a,o,8,16,f+9-n,e,n,16)sspr(a,o,8,16,f+8,e,n,16,true)end elseif self.type<10then spr(self.spr,f+4,e+sin(self.anim)*2,1,2)end end end return f end function ev(f)if(not h(6)or count(d)>0)return
f.blink-=1if(f.blink<=1)f.blink=30+flr(rnd(60))
Z=btn(4)and fo==false fo=btn(4)f.jgl=max(f.jgl-.2,0)if(btnp(5)and not l)e7()return nil
f.anim=min(f.anim+((f.sprint or f.oncnv or f.inprt)and.2or.1111),1)if f.anim>=.65then local n=K"2013"for e=0,3do if(btn(e))f.nextdir=n[e+1]
end end if f.anim+.001>=1and not l and not z then if(f.ismv)eF(f)
if l==false and f.ttch>=Q then l,m=true,62483if(B<dget(i.s_st))dset(i.s_st,B)fq=true
end if(Z)f.jgl=1
...
f.nextdir,f.dir=-1,e if a and not z and not l then fA=true if(m==nil and stat(49)==-1and not f.oncnv)m=61956
if not f.oncnv then if(not f.inprt)f.strnx,f.strny=f.x,f.y er()
F+=1F%=3M=true end f.anim,f.sprint,f.ismv=0,tonum(h(3))~tonum(btn(4))==1,true if(f.inprt==false)f.oldx,f.oldy=f.x,f.y
if(e>=0)f.x,f.y=d,c
end end end if(l)f.dir=3
if(fA and not l)B=min(B+(time()-fn),599.999)
end function eF(f)f.ismv=false local a,o,d,c,l,h=f.x,f.y,(f.oldx<<1)+2,(f.oldy<<1)+1,true,true if(f.prvcrfl)k(96,18,d-1,c)Q-=S(d,c)f.ttch-=1m=62278f.prvcrfl=false
local e,y,x,b,r,t,u,s,n,i=mget((a<<1)+2,(o<<1)+1),mget(d,c),a<<4|o,(a<<1)+1,(o<<1)+1,(a<<4)+12,o<<4if(e\16==12and f.pstate==2)e,m=123,62084
if(e==52)R(19,20,3,4)m,n=-349,"78e"
if(e==53)R(21,22,35,36)m,n=-349,"73b"
if(e==54)R(23,24,67,68)m,n=-349,"7dc"
if e==55then f.coins+=1m,n=63494,"49a"if(f.coins==3)f.coins,m=0,-349R(25,26,99,100)
f1=true end if(f.prvsltr)k(126,26,d-1,c)m=62084
f.prvsltr=e==48for n=0,2do if(e==80+n)i=f6[n+1]f.pstate,m=n,fx[n+1]
end for n=0,7do if e==56+n then if f.octg==n then f.octg+=1m=fP[n+1]for e in all(g)do if(e.oct_ind==f.octg)e_(t,u+6,(e.x<<4)+12,(e.y<<4)+6)
end else l=false end end end if(f.octg==8)R(27,28,74,106)f.octg=0
if(e==18)if f.haskey then l=false else f.haskey,n,m=true,"67",63494end
if(e==51)f.haskey,m=false,-349
if(e==125or e==127)f.prvcrfl,m=true,62210
if(e==121)m=fx[2]
...
break end end if f.inprt then f.inprt,i=false,f6[f.pstate+1]else for n=0,6,2do if(e==89+n)k(126,f.pstate<<1,b,r)f.oldx,f.oldy,f.inprt,m,f.x,f.y=a,o,true,63142,s.dst_x,s.dst_y
end end if(e==123and f.pstate==1)e=192k(112,14,b,r)
if(e>208)fH(f)h=false
if e\16==11and f.pstate==0or e\16==12or e==50or e==29and F==0or e==30and F==1or e==31and F==2then fH(f,true)elseif h then f.ttch+=1k(126,f.pstate<<1,b,r)end if(n~=nil)fI(t,u+8,K(n))
if(i~=nil)fJ(t,u+12,i)
end function fH(f,e)z=true if(e)m=61448f.isdead=true fJ((f.x<<4)+12,(f.y<<4)+12,f6[f.pstate+1])
end function ez(f)if(f.isdead or f.inprt or not h(6))return
...
end function h(f)return dget(63)&1<<f>0end function ej(f,n)local f,e=1<<f,dget(63)dset(63,n and e|f or e&~f)end function fz()return{stage=dget(62)<<4&15,world=dget(62)<<7&7}end function e6(f,e)dset(62,dget(62)&~.9922|f>>7|e>>4)end function f3(e)local f=0for e in all(r[e])do if(dget(e.s_st)<599.995)f+=1
end return f end function fi(f)return f3(f)>=J[f]end function fK(f)return f3(f)>=count(r[f])end function fB()local f=count(r)return f3(f)>=J[f]end function f9(f,e)for f in all(r[f])do if(dget(f.s_st)>(e and f.s_dt or f.s_gt))return false
end return true end function fc()for f=1,count(r)do if(not fK(f))return false
end return true end function H(f)for e=1,count(r)do if(not f9(e,f))return false
end return true end function ef()cls(0)map(0,0,-24*s,32,19,2)map(0,2,s*2%1*-24,48,19,3)map(0,5,s*3%1*-24,72,19,7)palt(1024)local f=sin(s)*4map(19,0,12,8+f,13,7)if(not h(6))map(19,8,28,8+f,4,5)
?"2025 cyansorcery",32,122,3
?"beta 2",1,1,1
palt()pal(7,1)if(fc())spr(241,1,119)
if h(1)then if(H(false))?"⧗",113,122,7
if(H(true))?"♥",120,122,7
end pal()if(count(d)==0and q==nil)fb("press 🅾️ to start!",28,96,1,1.4)
end function e3()local e=j*a local f=e*8cls(1)rectfill(0,56,127,72,12)map(0,12,-24*s,56-f,19,1)map(0,13,-24+24*s,64+f,19,1)local f=f*.5?"presented by",39,60-f,1
if(h(6))map(19,7,18,60+f,11,1)
palt()fillp(fu[flr(p(1,4,e))])rectfill(0,56,127,72,12)fillp()end function fF()if(j*a==1and btnp()&48>0)if D==5then u(1)else u(0)end
...
end function e0()s+=.025s%=1if W>0then W-=1if(btnp()&48>0)W=0
if(W==0)u(0)
end end function e4()s+=.01s%=1if count(d)==0then local f=btn(6)if(f)poke(24368,1)
if(btnp()&48>0or f)m=61828eq()
end end function e2()A=mid(0,A+E,1)s+=.02s%=1local f=count(r)if A==1then if(btnp(0)and b>1)m=61700N=max(b-1,1)E=-.125
if(btnp(1)and b<count(r)and fi(b))m=61700N=min(b+1,f)E=-.125
end if(A==0)E=.125b=N N=nil
local f,e=count(r[b]),btn(6)if(e)poke(24368,1)
if(btnp(2))w-=1m=61700
if(btnp(3))w+=1m=61700
if(w<0)w=f
if(w>f)w=0
if btnp()&48>0or e then if(w==0)u(0)m=63333else u(2,b,w)music(-1,500)m=61828
end end function e8()local a,f=ee,20+sin(A>>3)*29for f=1,4do pal(a[1][f],a[b][f])end rectfill(0,0,127,127,1)map(0,14,-24+24*s,-2-f,19,3)map(0,17,-24*s,115+f,19,2)map(32,-2+b*2,0,1-f,16,2)local f,e=122+f,J[b]if(b>1)?"⬅️previous area",1,f,7
local n=f3(b)?n>=e and(b<count(r)and"next area➡️"or"")or"▶solve "..e-n,84,f,7
local e=count(r[b])local o=max(min(w-5,e-9),-1)local n,d,i,c,l,f=13-o*10,o+10,h(1)for e=0,e do c,fL=e==w,n+10if e>o and e<d then f=n+3local o=r[b][max(1,e)]local d=dget(o.s_st)if(c)fM(4,n,90,fL)
pal(7,c and 7or a[b][2])if e>0then?(e>9and""or" ")..e.." "..o.s_nm,14,f,7
spr(d<=599.995and 241or 240,6,n+1)if i then if(d<=o.s_gt)?fE(d),96,f,7
if(d<=o.s_dt)?"♥",120,f,7
end else?"back",26,f,7
pal(7,10)if(fK(b))spr(241,6,n+1)
if i then if(f9(b,false))?"⧗",113,f,7
if(f9(b,true))?"♥",120,f,7
end end end n=fL end if A<1then palt()if(E<0)pal(1,a[N][1])
fillp(fu[flr(p(1,4,A))])if(E>0)rectfill(0,22,127,112,1)else rectfill(0,0,127,127,1)
fillp()end pal()end function fr(e,n,a,f)add(d,{m_x=e,m_y=n,m_w=a,m_h=count(f)*10+6,m_items=f,m_highlight=1,m_anim_incr=.25,m_anim_factor=0,m_step=function(f,n)local e=count(d)local n,a,o=n==e,btn(6),count(f.m_items)if(a)poke(24368,1)
if f.m_anim_factor==1then if(btnp(2))f.m_highlight-=1m=61700
if(btnp(3))f.m_highlight+=1m=61700
if(f.m_highlight<1)f.m_highlight=o
if(f.m_highlight>o)f.m_highlight=1
if(btnp(5)or btnp(4)or a)m=61828f.m_items[f.m_highlight]:i_onclick()
...
local e,t,a=count(f.m_items),count(g)>0and 147or 241,p(5,f.m_h,f.m_anim_factor)local n,e,o=f.m_x,f.m_y-(a>>1)local a,d,i,l,b,r=n+f.m_w,e+a rectfill(n,e,a,d,1)rect(n+1,e+1,a-1,d-1,13)local u,e=n+8,e+6for s,c in pairs(f.m_items)do if e<d-9then i,l,b,r=n+3,e-3,a-3,e+7o=s==f.m_highlight if(o)fM(i,l,b,r)
pal(7,o and 7or 13)?c.i_label,u,e,7
if(c.i_setting~=nil)spr(t-(h(c.i_setting)and 0or 1),a-11,e-2)
end e+=10end pal()end})end function fg()for f in all(d)do f.m_anim_incr=-.25end end function fN()m=63333d[count(d)].m_anim_incr=-.25end function o(f,e)return{i_label=f,i_onclick=e,i_setting=nil}end function f(f,e)local f=o(f,function(f)ej(f.i_setting,h(f.i_setting)==false)if(f.i_setting==5)music(h(5)and 0or-1,0,7)
end)f.i_setting=e return f end function es()Z,fo,m=false,false,61828local f if(not ei and fi(v))f=5
if(not ea and fB())f=1
if(not eo and fc())f=2
if(not ed and H(false))f=3
if(not ec and H(true))f=4
if(f~=nil)u(5,f)return
local e,n,a,f=o((l and"next"or"skip").." puzzle",function()if(C+1>count(r[v]))u(1)else u(2,v,C+1)
end),o("restart puzzle",function()u(2,v,C,true)end),o("stage select",function()u(1)end)if(l)f={e,n,a}else f={o("back",fN),n,e,o((f0==2and"hide"or"show").." hints",function()f0=f0==2and 1or 2fg()end),a,o("options",fO),o("go to title",function()u(0)end)}
fr(16,64,96,f)end function eq()fr(24,96,80,{o("start game",function()u(1)end),o("continue",function()local f=fz()u(2,f.world,f.stage)end),o("options",fO),o("credits",function()u(4)end),o("back",function()u(3)end)})end function fO()fr(16,count(g)>0and 64or 72,96,{o("back",fN),f("show timers",1),f("slime overlap",2),f("sprint by default",3),f("sound effects",4),f("music",5),f("lesbians allowed",6),o("exit game",function()extcmd"shutdown"end),o("pico8 menu",eA)})end function eA()extcmd"pause"end function fM(f,e,n,a)rectfill(f,e,n,a,2)fillp(f7[ceil(U)])rect(f,e,n,a,154)fillp(0)end function f4(e,n,a,o,d,f)if(count(P)<100)add(P,{x=e,y=n,spd=a,dir=o,col=d,time_max=f,time=f})
end function fJ(d,c,o)local f,e,n for a=0,.9,.1do f,e,n=d+cos(a)*4,c+sin(a)*4,a*360f4(f,e,.9,n,rnd(o),12)f4(f,e,1.8,n,rnd(o),8)end end function e_(a,o,e,n)for f=0,.8,.2do f4(p(a,e,f),p(o,n,f),0,0,14,p(5,12,f))end fI(e,n,{14,7})end function fI(e,n,a)for f=0,.9,.1do f4(e+cos(f)*4,n+sin(f)*4,.8,f*360,rnd(a),8)end end function eh()for f in all(P)do local e=f.dir/360f.x+=f.spd*cos(e)f.y+=f.spd*sin(e)f.time-=1if(f.time<=0)del(P,f)
end end function ew()for f in all(P)do pal(7,f.col)spr(flr(p(163,161,f.time/f.time_max)+.5),f.x,f.y)end end
__gfx__
...

__gff__

__sfx__

