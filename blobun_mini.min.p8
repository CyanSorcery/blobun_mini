...
if b>0then local i,f="stage "..nd,cos(abs(max(abs(b-45),35)-35)/40)*64-64local e,d,f=f+8,f+9,F(i,f+12,97,7,n)line(d,105,d+f,105,n)line(e,104,e+f,104,7)F(c.l_name,e,107,7,n)if(o>0)?c.l_author,e,115,n
end for n,o in pairs(i)do o:m_draw(n)end end function n(n)n_(1)nY(1,0,0)music(n)f=0end function nv()n(-1)I(nZ,o0)S=90end function nU()n(-1)I(o1,on)end function nV()n(-1)I(oo,o2)local n=nF()u,K=mid(1,n.world,count(s))j=mid(1,n.stage,count(s[u]))f,A,C,oe=0,0,.125,m("13b224cd02415d6d2494",4)end function nX()n(-1)I(of,od)T=0end function nW(n,o)I(o4,o3)local e=n1~=2n_(2)oi(1)memset(8192,0,4096)r,n4,D,U,n3,nj={},{},{},{},{},61936.8827ni,L,M,E,p,na,nl=0,0,0,0,0,0,-8V,nr,d,k,G,w,nA,b=true,false,false,false,false,false,false,nT==true and 0or 90,false z,W,q,nq,N,X,nt,nc=0,true,0,false,-1,5,0,0n=mid(1,n,count(s))o=mid(1,o,count(s[n]))oa(n,o)J,nd,c=n,o,s[n][o]if(e)poke(24405,0)local o=m("2854ef234924d6d54924",4)for e=1,4do pal(o[1][e],o[n][e])end spr(1,8,0,14,1)spr(16,0,8,2,2)poke(24405,96)
local f,i,a,d,l,e,n,o={},#c.l_data,c.l_data,1,(c.l_width<<1)+1,0,1,1for i=1,i do d+=2e=g(a,d,1,1)f[i]=e if(e>0)n5(n,o,(n+o)%4==2and 17or 16)
n+=2if(n>=l)n=1o+=2
...
local n=count(s[u])local i=max(min(j-5,n-9),0)local n,l,r,a,o,f=23-i*10,i+10,h(1)for o,d in ipairs(s[u])do a,nE=o==j,n+10if o>i and o<l then f=n+3local i=dget(d.l_saveslot)if(a)nG(4,n,90,nE)
...
sspr(f,d,8,16,n+9-e,o,e,16)sspr(f,d,8,16,n+8,o,e,16,true)end end function n:onstep()self.anim+=.02self.anim%=1self.spin+=.035self.spin%=1end return n end function O(r,t,s,c)local f,n,d,i,a,l,u for o=32,48do for e=0,16do n,f=nil,mget(o,e)if mget(o+16,e)&2==0then if f==r then n,d,l=t,c,1elseif f==t then n,d,l=r,s,0end if n~=nil then u=c<56mset(o,e,n)mset(o+16,e,l)i,a=(o-32<<1)+1,(e<<1)+1if(u)n5(i,a,d)else nu(i,a,n)
end end end end end function x(n,o,e)return n+(o-n)*e end function oy()local n={}n.obj_list={}for o,e in pairs(r)do n.obj_list[o]=r[o]end local o=r[1]n.player_x,n.player_y,n.player_dir,n.player_pstate,n.player_coins,n.tiles_touched,n.player_octogems,n.player_haskey,n.zapper_turn=o.startturnx,o.startturny,o.dir,o.pstate,E,L,p,o.haskey,z add(D,n)n.playfield_walls,n.playfield_slime,n.playfiend_main=n9(32,16),n9(48,16),n9(0,32)if(count(D)>20)deli(D,1)
end function om()local o=count(D)if(o==0)return
local n=D[o]if(o>1)deli(D)
r=n.obj_list local o=r[1]o.x,o.y,o.oldx,o.oldy,o.anim,o.dir,o.pstate,E,L,p,o.haskey,z=n.player_x,n.player_y,n.player_x,n.player_y,1,n.player_dir,n.player_pstate,n.player_coins,n.tiles_touched,n.player_octogems,n.player_haskey,n.zapper_turn N,k,o.isdead,V,W,o.ismove=-1,false,false,true,true,false ns(n.playfield_walls,32,16)ns(n.playfield_slime,48,16)ns(n.playfiend_main,0,32)end function n9(f,e)local n={}for o=0,e do n[o]={}for e=0,e do n[o][e]=mget(o+f,e)end end return n end function ns(e,f,n)for o=0,n do for n=0,n do mset(o+f,n,e[o][n])end end end function P(n,o)if(mget(n+32,o)~=9)return false
n6(n,o,192)mset(n+48,o,0)mset(n+32,o,0)P(n-1,o)P(n+1,o)P(n,o-1)P(n,o+1)return true end function nJ(e)local n,o=c.l_width+32,c.l_height for n=32,n do for o=0,o do if(mget(n,o)==e)return{x=n-32,y=o}
...
return print(n,o,e,f)end function nH(n)return(n>=60and flr(n/60)..":"or"")..sub(flr(n%60)+100,2,3).."."..sub(flr(n%1*1000)+1000,2,4)end function m(d,n)local o,f,e={},#d\n for f=1,f do o[f]={}e=(f-1)*n for n=1,n do e+=1add(o[f],g(d,e,0,1))end end return o end function g(e,n,o,f)return tonum(sub(e,n,n+(o and o or 0)),f)end function ol(n,o)add(r,{type=0,x=n,y=o,startx=n,starty=o,pos=-1,dir=3,anim=1,sprint=false,jiggle=0,ismove=false,pstate=0,oldx=n,oldy=o,startturnx=n,startturny=o,isdead=false,haskey=false,onstep=ok,ondraw=ow},1)end function ok(n)if(not h(6)or count(i)>0)return
n8=btn(4)and nr==false nr=btn(4)n.jiggle=max(n.jiggle-.2,0)if(btnp(5)and not d)om()
n.anim=min(n.anim+((n.sprint or G or w)and.2or.1111),1)if n.anim>=.65then local o={2,0,1,3}for n=0,3do if(btn(n))N=o[n+1]
end end if n.anim+.001>=1and not d and not k then if(n.ismove==true)nD(n)
if(n8)n.jiggle=1
n.sprint=false local o=N if o~=-1or w then local d,i,e,f=w,1,n.x+cos(o>>2),n.y+sin(o>>2)if(G or h(2))i=3
local a=mget(e+32,f)if(a==10and n.pstate==1or a==138and n.haskey or mget(e+48,f)&i>0)d=true
N,n.dir=-1,o if d and not k then nq=true if(not w and not G)n.startturnx,n.startturny=n.x,n.y oy()z+=1z%=3W=true
n.anim,n.sprint,n.ismove=0,tonum(h(3))~tonum(btn(4))==1,true if(w==false)n.oldx,n.oldy=n.x,n.y
if(o>=0)n.x,n.y=e,f
end end end if d==false and L>=ni then d=true if(q<dget(c.l_saveslot))dset(c.l_saveslot,q)nA=true
end if(d)n.dir=3
...
if(o==2)O(3,4,19,20)e,a={8,7},v.t_switch
if(o==34)O(35,36,21,22)e,a={11,7},v.t_switch
if(o==66)O(67,68,23,24)e,a={12,7},v.t_switch
if o==98then E+=1e,a={10,9,7},v.t_coin if(E==3)E=0O(99,100,25,26)a=v.t_switch
V=true end local i=m("b31a9876d",3)for f=0,2do if(o==8|f<<5)n.pstate,e,a=f,i[f+1],v.p_state[f+1]
end for n=0,7do if o==15|n<<5and p==n then p+=1if p<8then local n=nJ(15|p<<5)if(n~=nil)oz(r,t,(n.x<<4)+12,(n.y<<4)+12)
end e,a={14,7},v.octo[n+1]end end if(p==8)O(74,106,27,28)p=0
...
if(o==41and n.pstate==0or o==73and n.pstate~=2or o==0or o==39and z==2or o==7and z==1or o==71and z==0)nL(n,true)else L+=1mset(n.x+48,n.y,2)nu((n.x<<1)+1,(n.y<<1)+1,218+(n.pstate<<1))
end function nL(n,o)k=true local e=m("13b49a5d6",3)if(o==true)n.isdead=true ov((n.x<<4)+12,(n.y<<4)+12,e[n.pstate+1])
end function ow(n)if(n.isdead or w or not h(6))return
local i,o,e,f,d=n.dir,n.x<<4,n.y<<4,n.anim if(n.pstate==1)pal(3,8)pal(11,9)
if(n.pstate==2)pal(3,13)pal(11,6)
if(f<1)d=G and f or.5+cos(f*.5*sgn(f-.5))*-.5o,e=x(n.oldx<<4,n.x<<4,d),x(n.oldy<<4,n.y<<4,d)
...
pal()end function o9()local f=nt spr(224,80,104,6,2)local n,e=80for d=0,32,16do clip(n,104,16,16)for o=0,15do e=sin(f+o/8)+104sspr(d+o,112,1,16,n+o,e)sspr(n,104+o,16,1,n,e+o)end n+=16end local o=r[1]clip()palt(0,false)spr(208,24,104,3,1)palt()if(o.haskey)spr(144,32,104)spr(144,39,104,1,1,true)
...
local o,e,n=(btn(4)or o.sprint)and G==false,X<3or d n=215if(o)n=214
if(e or k)n=216
spr(n,d and 37or 36,104,1,1,d)n=251if(o)n=252
if(k)n=160
if(d)n=250
spr(n,40,104)for n=0,23do for o=0,7do sset(79-o,104+n,sget(24+n,104+o))end end end function Z(o,e,f,d,i,a,l,n)add(U,{x=o,y=e,spd=f,dir=d,spr1=i,spr2=a,col=l,time_max=n,time=n})end function ov(i,a,d)local n,o,e for f=0,.9,.1do n,o,e=i+cos(f)*4,a+sin(f)*4,f*360Z(n,o,.9,e,164,167,rnd(d),12)Z(n,o,1.8,e,164,167,rnd(d),8)end end function oz(f,d,o,e)for n=0,.8,.2do Z(x(f,o,n),x(d,e,n),0,0,164,167,14,x(5,12,n))end nK(o,e,{14,7})end function nK(o,e,f)for n=0,.9,.1do Z(o+cos(n)*4,e+sin(n)*4,.8,n*360,164,167,rnd(f),8)end end function op()for n in all(U)do local o=n.dir/360n.x+=n.spd*cos(o)n.y+=n.spd*sin(o)n.time-=1if(n.time<=0)del(U,n)
end end function oh()for n in all(U)do pal(7,n.col)spr(flr(x(n.spr2,n.spr1,n.time/n.time_max)+.5),n.x,n.y)end pal()end function n_(n)if(n1==n)return false
...
local o,u,f=count(n.m_items),count(r)>0and 155or 241,x(5,n.m_h,n.m_anim_factor)local e,o,d=n.m_x,n.m_y-(f>>1)local f,i,l,r,t,c=e+n.m_w,o+f rectfill(e,o,f,i,1)rect(e+1,o+1,f-1,i-1,13)local s,o=e+8,o+6for x,a in pairs(n.m_items)do if o<i-9then l,r,t,c=e+3,o-3,f-3,o+7d=x==n.m_highlight if(d)nG(l,r,t,c)
pal(7,d and 7or 13)?a.i_label,s,o,7
if(a.i_setting~=nil)spr(u-(h(a.i_setting)and 0or 1),f-11,o-2)
end o+=10end pal()end})end function nf()for n in all(i)do n.m_anim_incr=-.25end end function e(n,o)return{i_label=n,i_onclick=o,i_setting=nil}end function n0(n,o)local n=e(n,function(n)o_(n.i_setting,h(n.i_setting)==false)end)n.i_setting=o return n end function ob()nh(16,64,96,{e((d and"next"or"skip").." puzzle",function()o(2,J,nd+1)end),e("restart puzzle",function()o(2,J,nd,true)end),e("show hints",o5),e("stage select",function()o(1)end),e("options",nM),e("go to title",function()o(0)end)})n8,nr=false,false end function o6()nh(24,96,80,{e("start game",function()o(1)end),e("continue",function()local n=nF()o(2,n.world,n.stage)end),e("options",nM),e("credits",function()o(4)end)})end function nM()nh(16,count(r)>0and 64or 92,96,{n0("show timers",1),n0("slime overlap",2),n0("sprint by default",3),n0("lesbians allowed",6),e("pico8 menu",oF)})end function oF()extcmd"pause"end function nG(n,o,e,f)rectfill(n,o,e,f,2)fillp(ng[ceil(R)])rect(n,o,e,f,154)fillp(0)end function nR()cartdata(nO)if(dget(63)==0)dset(63,69)for n=0,59do dset(n,599.999)end dset(62,0x1.12)dset(61,0)dset(60,0)
end function h(n)return dget(63)&1<<n>0end function o_(n,e)local n,o=1<<n,dget(63)dset(63,e and o|n or o&~n)end function nF()return{stage=dget(62)<<4&15,world=dget(62)<<7&7}end function oa(n,o)dset(62,dget(62)&~.9922|n>>7|o>>4)end
__gfx__
